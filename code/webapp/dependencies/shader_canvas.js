...
class ReadPixels1 extends globalThis.HTMLElement {
...
class DrawCallsContainer extends CanMerge {
    ...
    async buildDrawFunction(gl, context, renderers, updaters) {
        ...
        for (const child of Array.from(this.children)){
            ...
            } else if (child instanceof ReadPixels1) {
...
class DrawLoop1 extends DrawCallsContainer {
...
class DrawCalls1 extends DrawCallsContainer {
    ...
    async initialize(gl, context, renderers, updaters) {
        await this.whenLoaded;
        await this.buildDrawFunction(gl, context, renderers, updaters);
        const drawLoopElem = this.querySelector(DrawLoop1.tag);
        if (drawLoopElem && drawLoopElem instanceof DrawLoop1) {
...
class ShaderCanvasContainer1 extends CanMerge {
    content = new Map();
...
class NewModules extends ShaderCanvasContainer1 {
...
class WebGLPrograms extends ShaderCanvasContainer1 {
...
class WebGLBuffers extends ShaderCanvasContainer1 {
...
class WebGLFramebuffers extends ShaderCanvasContainer1 {
...
class WebGLVertexArrayObjects extends ShaderCanvasContainer1 {
...
class WebGLTextures extends ShaderCanvasContainer1 {
...
class WebGLCanvas extends globalThis.HTMLElement {
    ...
    async initialize(init) {
        const { width , height , programInitializers , modulesFunctions , bufferInitializers , flags ,  } = init;
        await this.whenLoaded;
        ...
        let drawCallsRoot = this.querySelector(DrawCalls1.tag);
        if (!drawCallsRoot) {
            drawCallsRoot = globalThis.document.createElement(DrawCalls1.tag);
            this.append(drawCallsRoot);
        }
        if (drawCallsRoot instanceof DrawCalls1) {
            ...
            console.warn(`<webgl-canvas>: unable to initialize the <${DrawCalls1.tag}>`);
        }
    }
    createContext(gl, { payloads , modulesFunctions , flags  }) {
    ...
    async initialize(options) {
        ...
        if (this.webglCanvas) {
            ...
            if (this.webglCanvas instanceof WebGLCanvas) {
                ...
                if (loopElement && loopElement instanceof DrawLoop1) {
...
export { DrawCalls1 as DrawCalls, DrawLoop1 as DrawLoop, ReadPixels1 as ReadPixels, ShaderCanvasContainer1 as ShaderCanvasContainer };
